...
const inputTop = document.getElementById("products");
...
inputTop.addEventListener("change", function (event){
    ...
    if(inputTop.value) {
        ...
        itemProducts.style.display = "none";
    }
})
...
const inputBottom = document.getElementById("orders");
...
const checkboxAcc = document.getElementById("accounting");
...
const checkboxTer = document.getElementById("terminal");
